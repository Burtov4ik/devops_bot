## Описание
 В данной ветке проект разворачивается с использованием Docker Compose и включает в себя основную базу данных и базу данных для репликации.
...
1. **Клонируйте репозиторий с веткой `docker`:**
   ```sh
   git clone https://github.com/Burtov4ik/devops_bot.git -b docker
   cd devops_bot
   ```
